...
@Component({
  selector: 'app-balance-transfer-loan',
  templateUrl: './balance-transfer-loan.component.html',
  styleUrls: ['./balance-transfer-loan.component.scss']
})
export class BalanceTransferLoanComponent implements OnInit {
